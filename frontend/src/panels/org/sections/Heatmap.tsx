...
export function OrgHeatmap() {
  ...
  return (
    <>
      <SectionHeader
        eyebrow="Talent heatmap"
        title="Where your candidates live"
        description="Density of profiles that match your skill needs. Switch sectors and zoom into a country."
        actions={
      ...
      <div className="space-y-6 px-8 py-6">
        ...
        <HeatPerformance audience="org" focusId={focus.id} presetId={preset.id} baseColor={baseColor} />
      </div>
    </>
  );
}