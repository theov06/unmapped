...
export function GovProfilesMap() {
  ...
  return (
    <>
      <SectionHeader
        eyebrow="Heatmap · Profiles"
        title="Where the talent lives"
        description="Density of indexed youth profiles. Pick a sector and zoom into a country."
        actions={
